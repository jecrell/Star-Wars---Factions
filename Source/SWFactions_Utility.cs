...
namespace SWSaber
{
    public static class Utility
    {
        ...
        {
            Log.Message(text: "Mod Check Called");
            ...
            foreach (ModContentPack ResolvedMod in LoadedModManager.RunningMods)
            {
                ...
                if (ResolvedMod.Name.Contains(value: "Star Wars - The Force"))
                {
                    Log.Message(text: "Lightsabers :: Star Wars - The Force Detected.");
                ...
                //    loadedFactions = true;
                //}
                if (ResolvedMod.Name.Contains(value: "Star Wars - Fully Functional Lightsabers"))
                {
                    Log.Message(text: "Lightsabers :: Star Wars - Lightsabers.");
